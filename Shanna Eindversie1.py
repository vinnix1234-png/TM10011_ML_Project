...
hyperparameter_grid_logistic_regression = {
    ...
    'l1_ratio': [0.0, 0.005, 0.1, 0.3, 0.5, 0.9, 1.0]   # 0.0 = L2, 1.0 = L1, tussenin = elasticnet, penalty hoeft niet.
}
...
def get_feature_selection_methods(classifier, clf_name):
    ...
    if clf_name == "Logistic Regression":
        ...
        methods["RFE"] = RFE(clone(classifier), n_features_to_select=10, step=10)        # step=10
...
# Nested CV
# Cross-validaties
outer_cv = StratifiedKFold(n_splits=10, shuffle=True, random_state=42)   # shuffle=True moet, anders error op random_state
